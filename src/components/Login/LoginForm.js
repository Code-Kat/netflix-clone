                  ...
                  <form>
                      ...
                      <div className="input-container">
                          ...
                          className={
                            ...
                            required />
                          <label on>Email or Phone Number</label>
                          <span style={{color: '#db7302', fontSize: '.8rem'}}>{this.state.emailError}</span>
                      </div>
                      <div className="input-container">
                          <input 
                          className={
                          ...
                          <span style={{color: '#db7302', fontSize: '.8rem'}}>{this.state.passwordError}</span>
                      </div>
                      <div className="input-container">
                      ...
                      <label className="checkbox-container">
                          Remember me 
                          <input type="checkbox" defaultChecked={this.state.checked} onChange={this.state.handleCheckbox}></input>
